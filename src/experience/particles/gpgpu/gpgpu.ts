...
class Gpgpu {
    ...
    constructor(baseGeometry: BufferGeometry, config: UniformConfig) {
    ...
    private configParticlesVariable(): void {
        ...
        this.particlesVariable.material.uniforms.uFlowFieldInfluence = new Uniform(this.config.uFlowFieldInfluence)
        this.particlesVariable.material.uniforms.uFlowFieldStrength = new Uniform(this.config.uFlowFieldStrength)
        this.particlesVariable.material.uniforms.uFlowFieldFrequency = new Uniform(this.config.uFlowFieldFrequency)
